...
<div class="fixed bottom-6 right-6 z-50">
    <a href="#" id="whatsapp-btn" onclick="openWhatsApp()"
    ...
    <!-- Tooltip -->
    <div
        class="absolute bottom-full right-0 mb-2 bg-gray-800 text-gray-300 text-sm px-3 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
...
<script>
    ...
    function openWhatsApp() {
        ...
        const message =
            `${requestId} - Halo, Saya tertarik dengan fitur WOFINS untuk sistem wedding organizer dan ingin mengetahui lebih lanjut tentang demo, pricing, dan implementasinya. Terima kasih!`;
