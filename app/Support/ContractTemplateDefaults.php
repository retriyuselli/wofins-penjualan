    ...
    public static function spkSections(): array
    {
        return [
            ...
            [
                ...
                'is_enabled' => true,
                'body' => '<p>Waktu pelayanan dimulai sejak diterbitkannya invoice setelah dibayarkannya DP dan ditandatanganinya surat perjanjian ini hingga selesai pelaksanaan pernikahan. Sedangkan, pelaksanaan pernikahan dilaksanakan pada:</p><p><b>Akad:</b></p><ol type="a"><li>Tanggal : {{akad_date}}</li><li>Waktu : {{akad_time}} (waktu akan menyesuaikan)</li><li>Lokasi : {{prospect_venue}}</li></ol>',
            ],
            [
            ...
            [
                ...
                'is_enabled' => true,
                'body' => '<p>Total Biaya jasa pernikahan yang digunakan untuk acara {{event_name}} pada {{akad_date}} adalah senilai {{package_price}}.</p>',
            ],
            [
